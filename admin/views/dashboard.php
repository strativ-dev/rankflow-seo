	...
	<div class="dashboard-content">
		<div class="dashboard-main">
			<div class="stats-grid">
				<div class="stat-card">
					<div class="stat-icon">
						<img src="<?php echo esc_url( RANKFLOW_SEO_PLUGIN_URL . 'assets/images/published-posts-icon.png' ); ?>" alt="Published Posts" class="rankflow-seo-icon-45">
					</div>
				...
				<div class="stat-card">
					<div class="stat-icon">
						<img src="<?php echo esc_url( RANKFLOW_SEO_PLUGIN_URL . 'assets/images/optimized-posts-icon.png' ); ?>" alt="Optimized Posts" class="rankflow-seo-icon-45">
					</div>
					<div class="stat-content">
				...
				<div class="stat-card">
					<div class="stat-icon">
						<img src="<?php echo esc_url( RANKFLOW_SEO_PLUGIN_URL . 'assets/images/avarage-seo-score-icon.png' ); ?>" alt="Average SEO Score" class="rankflow-seo-icon-45">
					</div>
					<div class="stat-content">
				...
				<div class="stat-card">
					<div class="stat-icon">
						<img src="<?php echo esc_url( RANKFLOW_SEO_PLUGIN_URL . 'assets/images/ai-icon.png' ); ?>" alt="AI Provider" class="rankflow-seo-icon-45">
					</div>
					<div class="stat-content">
						<h3><?php echo esc_html( RankFlow_SEO_Helper::get_provider_name( get_option( 'rankflow_seo_api_provider', 'gemini' ) ) ); ?></h3>
						...
						<tbody>
							...
							foreach ( $rankflow_seo_recent_posts as $rankflow_seo_post ) :
								...
								<tr>
									...
									<td>
										<a href="<?php echo esc_url( get_edit_post_link( $rankflow_seo_post->ID ) ); ?>" class="button button-small">
