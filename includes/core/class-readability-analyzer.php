...
class MPSEO_Readability_Analyzer
{
	...
	public function analyze($content)
	{
		...
		if ($word_count < 10) {
			return array(
				'problems' => array(
					array(
						'title' => __('Content length', 'metapilot-smart-seo'),
						'message' => __('Add more content to analyze readability.', 'metapilot-smart-seo'),
					),
				),
				'good' => array(),
				'flesch_score' => 0,
		...
		if ($long_sentence_percentage <= 25) {
			$good[] = array(
				'title' => __('Sentence length', 'metapilot-smart-seo'),
				'message' => sprintf(
					/* translators: %s: percentage of sentences with more than 20 words */
					__('%s%% of the sentences contain more than 20 words, which is less than or equal to the recommended maximum of 25%%. Good job!', 'metapilot-smart-seo'),
			...
			$problems[] = array(
				...
				'message' => sprintf(
					/* translators: %s: percentage of sentences with more than 20 words */
					__('%s%% of the sentences contain more than 20 words, which is more than the recommended maximum of 25%%. Try to shorten the sentences.', 'metapilot-smart-seo'),
					number_format($long_sentence_percentage, 1)
				),
			);
		}
		...
		if ($long_paragraphs === 0) {
			$good[] = array(
				'title' => __('Paragraph length', 'metapilot-smart-seo'),
				'message' => __('None of the paragraphs are too long. Good job!', 'metapilot-smart-seo'),
			);
		} else {
			$problems[] = array(
				'title' => __('Paragraph length', 'metapilot-smart-seo'),
				'message' => sprintf(
					...
					__('%d of the paragraphs contain more than 150 words. Shorten them!', 'metapilot-smart-seo'),
					$long_paragraphs
				),
			);
		}
		...
		if ($subheading_analysis['status'] === 'good') {
			$good[] = array(
				'title' => __('Subheading distribution', 'metapilot-smart-seo'),
				'message' => __('You are using subheadings properly and the text structure looks great!', 'metapilot-smart-seo'),
			);
		...
		if ($transition_percentage >= 30) {
			$good[] = array(
				'title' => __('Transition words', 'metapilot-smart-seo'),
				'message' => sprintf(
					/* translators: %s: percentage of sentences containing transition words */
					__('%s%% of the sentences contain transition words, which is great!', 'metapilot-smart-seo'),
			...
			$problems[] = array(
				...
				'message' => sprintf(
					/* translators: %s: percentage of sentences containing transition words */
					__('Only %s%% of the sentences contain transition words, which is not enough. Use more of them.', 'metapilot-smart-seo'),
					number_format($transition_percentage, 1)
				),
			);
		} else {
			$problems[] = array(
				...
				'message' => sprintf(
					/* translators: %s: percentage of sentences containing transition words */
					__('Only %s%% of the sentences contain transition words. This is far below the recommended 30%%. Add more to improve flow.', 'metapilot-smart-seo'),
					number_format($transition_percentage, 1)
				),
			);
		}
		...
		if ($passive_percentage <= 10) {
			$good[] = array(
				'title' => __('Passive voice', 'metapilot-smart-seo'),
				'message' => sprintf(
					/* translators: %s: percentage of sentences containing passive voice */
					__('%s%% of the sentences contain passive voice, which is below the recommended maximum of 10%%. Good job!', 'metapilot-smart-seo'),
			...
			$problems[] = array(
				...
				'message' => sprintf(
					/* translators: %s: percentage of sentences containing passive voice */
					__('%s%% of the sentences contain passive voice, which is more than the recommended maximum of 10%%. Try to use their active counterparts.', 'metapilot-smart-seo'),
					number_format($passive_percentage, 1)
				),
			);
		}
		...
		if ($consecutive_analysis['max_consecutive'] <= 2) {
			$good[] = array(
				'title' => __('Consecutive sentences', 'metapilot-smart-seo'),
				'message' => __('There is enough variety in your sentences. Good job!', 'metapilot-smart-seo'),
			);
		} else {
			$problems[] = array(
				'title' => __('Consecutive sentences', 'metapilot-smart-seo'),
				'message' => sprintf(
					...
					__('%d consecutive sentences start with the same word. Mix it up!', 'metapilot-smart-seo'),
		...
		if ($complex_word_percentage <= 10) {
			$good[] = array(
				'title' => __('Word complexity', 'metapilot-smart-seo'),
				'message' => sprintf(
					/* translators: %s: percentage of complex words in the text */
					__('%s%% of the words in your text are considered complex. Good job!', 'metapilot-smart-seo'),
			...
			$problems[] = array(
				...
				'message' => sprintf(
					/* translators: %s: percentage of complex words in the text */
					__('%s%% of the words in your text are considered complex. Try to use simpler alternatives.', 'metapilot-smart-seo'),
					number_format($complex_word_percentage, 1)
				),
			);
		}
		...
		if ($flesch_score >= 60) {
			$good[] = array(
				'title' => __('Flesch Reading Ease', 'metapilot-smart-seo'),
				'message' => sprintf(
					/* translators: %s: Flesch Reading Ease score */
					__('The copy scores %s in the Flesch Reading Ease test, which is considered good. Good job!', 'metapilot-smart-seo'),
			...
			$problems[] = array(
				...
				'message' => sprintf(
					/* translators: %s: Flesch Reading Ease score */
					__('The copy scores %s in the Flesch Reading Ease test, which is considered fairly difficult to read. Try to make shorter sentences and use simpler words.', 'metapilot-smart-seo'),
					number_format($flesch_score, 1)
				),
			);
		} else {
			$problems[] = array(
				...
				'message' => sprintf(
					/* translators: %s: Flesch Reading Ease score */
					__('The copy scores %s in the Flesch Reading Ease test, which is considered very difficult to read. Simplify your text considerably.', 'metapilot-smart-seo'),
					number_format($flesch_score, 1)
				),
			);
		}
	...
	private function analyze_subheading_distribution($content)
	{
		...
		if ($word_count < 300) {
			return array(
				'status' => 'good',
				'message' => __('Text is short, subheadings are optional.', 'metapilot-smart-seo'),
			);
		}
		...
		if (empty($subheadings)) {
			return array(
				'status' => 'problem',
				'message' => __('You are not using any subheadings, although your text is long enough. This makes the text harder to scan.', 'metapilot-smart-seo'),
			);
		}
		...
		if ($long_sections > 0) {
			return array(
				...
				'message' => sprintf(
					...
					__('%d section(s) of your text have more than 300 words without a subheading. Add more subheadings to break up the text.', 'metapilot-smart-seo'),
					$long_sections
				),
			);
		}
		...
		return array(
			'status' => 'good',
			'message' => __('Great subheading distribution!', 'metapilot-smart-seo'),
		);
	}
