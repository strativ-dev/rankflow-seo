...
class AI_SEO_Pro_Meta_Manager
{
	...
	public function get_post_meta($post_id)
	{
		return array(
			...
			'og_title' => get_post_meta($post_id, '_ai_seo_og_title', true),
			'og_description' => get_post_meta($post_id, '_ai_seo_og_description', true),
			'twitter_title' => get_post_meta($post_id, '_ai_seo_twitter_title', true),
			'twitter_description' => get_post_meta($post_id, '_ai_seo_twitter_description', true),
			'robots' => get_post_meta($post_id, '_ai_seo_robots', true),
			'canonical' => get_post_meta($post_id, '_ai_seo_canonical', true),
			'auto_generate' => get_post_meta($post_id, '_ai_seo_auto_generate', true),
		);
	}
	...
	public function save_post_meta($post_id, $data)
	{
		$meta_fields = array(
			'title' => '_ai_seo_title',
			'description' => '_ai_seo_description',
			'keywords' => '_ai_seo_keywords',
			'focus_keyword' => '_ai_seo_focus_keyword',
			'og_title' => '_ai_seo_og_title',
			'og_description' => '_ai_seo_og_description',
			'twitter_title' => '_ai_seo_twitter_title',
			'twitter_description' => '_ai_seo_twitter_description',
			'robots' => '_ai_seo_robots',
			'canonical' => '_ai_seo_canonical',
		);
	...
	public function get_title($post_id)
	{
		...
		if (empty($title)) {
			...
			$separator = get_option('ai_seo_pro_title_separator', '-');
